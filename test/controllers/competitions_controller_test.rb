...
class CompetitionsControllerTest < ActionController::TestCase
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post :create, competition: { collegename: @competition.collegename, description: @competition.description, money: @competition.money, name: @competition.name }
    end
  ...
  test "should update competition" do
    patch :update, id: @competition, competition: { collegename: @competition.collegename, description: @competition.description, money: @competition.money, name: @competition.name }
    assert_redirected_to competition_path(assigns(:competition))
  end
